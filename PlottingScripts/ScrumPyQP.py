...
#    def MakeLoopless(self,intmets, intreacs):
        
    def MaxMinSol(self,objective):
        self.SetObjective([objective])
        self.SetObjDirec("Max")
        self.Solve()
        obj = self.GetObjVal()
        self.SetFixedFlux({objective : obj})
        self.SetObjective(self.sm.cnames)
        self.SetObjDirec("Min")
        self.Solve()
        sol = self.GetPrimSol()
        self.UnboundFlux(objective)
        return sol
